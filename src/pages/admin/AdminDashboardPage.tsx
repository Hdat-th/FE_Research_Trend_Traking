...
const activePremium = userOverview.premiumUsers;
const renewalRate = 81;

const totalPublications = publicationTrend.reduce((sum, item) => sum + item.value, 0);
const monthlyPublications = publicationTrend[publicationTrend.length - 1].value;
const peakPublicationGrowth = publicationTrend[publicationTrend.length - 1].growth;
const latestPublicationMonth = publicationTrend[publicationTrend.length - 1].month;
