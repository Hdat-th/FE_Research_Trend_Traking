...
const getSearchPlaceholder = (pathname: string) => {
  if (pathname.includes('users')) return 'Search users, roles, or emails...';
  if (pathname.includes('repository')) return 'Search DOI, title, author, or journal...';
  if (pathname.includes('pipelines')) return 'Search pipelines, logs, or endpoints...';
  if (pathname.includes('revenue')) return 'Search invoices, subscriptions, or payments...';
  if (pathname.includes('logs')) return 'Search activity logs, admin actions, or system events...';

  return 'Search reports, articles, users, or system logs...';
};
...
const AdminLayout = () => {
  ...
  const searchItems = [
    ...
    { label: 'Article Repository', path: '/admin/repository' },
    { label: 'User Governance', path: '/admin/users' },
    { label: 'Revenue & Subscription', path: '/admin/revenue' },
    { label: 'Data Pipeline', path: '/admin/pipelines' },
